...
Shader "UdonSpaceVehicles/Standard Cubemap"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float3 rotatedValue32 = RotateAroundAxis( float3( 0,0,0 ), ase_vertexNormal, _RotationAxis, ( _RotationAngle * UNITY_PI * ( 1.0 / 180.0 ) ) );
			float4 temp_output_4_0 = ( texCUBE( _MainTex, rotatedValue32 ) * _Color );
			o.Albedo = temp_output_4_0.rgb;
			o.Emission = ( (texCUBE( _EmissionMap, rotatedValue32 )).rgb * (_EmissionColor).rgb );
			float4 texCUBENode12 = texCUBE( _MetallicGlossMap, rotatedValue32 );
			o.Metallic = ( texCUBENode12.r * _Metallic );
			o.Smoothness = ( texCUBENode12.a * _Glossiness );
			o.Occlusion = ( texCUBE( _OcclusionMap, rotatedValue32 ).r * _OcclusionStrength );
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18900
0;982;1750;1098;2799.873;299.65;1.105117;True;True
Node;AmplifyShaderEditor.RangedFloatNode;41;-2078.232,699.3757;Inherit;False;Constant;_Float1;Float 1;13;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;39;-2104.754,809.887;Inherit;False;Constant;_Float0;Float 0;13;0;Create;True;0;0;0;False;0;False;180;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleDivideOpNode;40;-1828.476,709.3215;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.PiNode;37;-2146.749,601.0201;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;34;-2297.046,423.0963;Inherit;False;Property;_RotationAngle;Rotation Angle;12;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;35;-1856,464;Inherit;False;3;3;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.NormalVertexDataNode;29;-2083.223,-16.96165;Inherit;False;0;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.Vector3Node;33;-2208,176;Inherit;False;Property;_RotationAxis;Rotation Axis;11;0;Create;True;0;0;0;False;0;False;0,1,0;0,1,0;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.RotateAboutAxisNode;32;-1887.04,139.5311;Inherit;False;False;4;0;FLOAT3;0,0,0;False;1;FLOAT;0;False;2;FLOAT3;0,0,0;False;3;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RelayNode;31;-1455.16,-1.48898;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=97056B35ECC24C2E75B600B064E107D64496C79C